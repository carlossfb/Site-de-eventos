					...
					<main role="main" id="mained" class="inner cover text-center container">
						...
						<span class=" border-bottom mt-2 d-flex p-left"></span><br>
							<form method="POST" action="<?php if(!isset($_GET["editor"])){
								echo "action/insert_evento2.php";
							}else{echo "action/update_evento2.php";}
								...
								<div class="form-row">
									...
									<div class="col-md-4 mb-3 row">
										 <div class="col mb-2">
											...
											<textarea class="form-control" id="exampleFormControlTextarea1" name="obs" maxlength="150" rows="6" placeholder="Coloque aqui informações adicionais, como... open bar limitado, participações do dia, etc. "><?php if(isset($_GET['editor']) && isset($_GET['id'])){
									...
									<div class="col-md-3 ml-4 mr-3">
										...
										<div class="container border">
											<div class="custom-control custom-checkbox mt-2">
											 <input type="radio" class="custom-control-input"  value="Aberto ao publico" name="check" id="customCheck2">
											  <label class="custom-control-label" for="customCheck2">Aberto ao publico</label>
											</div>
											<div class="border m-2"></div>
											<div class="custom-control custom-checkbox">
											  <input type="radio" class="custom-control-input"  value="Aberto para publico especifico" name="check" id="Check1" checked>
											  <label class="custom-control-label" for="Check1">Aberto para publico<br> especifico</label>
											</div>		
											<span class="text-success"><?php if(isset($_GET['editor']) && isset($_GET['id'])){echo "Confirme: ".$evento['chek_evento'];}?></span>
										</div>
									</div>
								</div>
								  <div class="form-row">
									<div class="col-md-3 mb-3">
									  ...
									  <label for="validationServer05" <?php if(!isset($_GET['editor'])){echo "style='margin-top:25px;'";} ?>>Cep do local</label>
